...
// Кэш промпта анализа карусели — заполняется при первом вызове handleAnalyzeCarousel
let CAROUSEL_ANALYSIS_PROMPT = '';
...
Верни ТОЛЬКО JSON, без пояснений, без markdown.`;
  ...
  // Сохраняем для переиспользования в analyze-carousel-from-url
  CAROUSEL_ANALYSIS_PROMPT = prompt;
