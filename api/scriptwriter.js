...
- ВАЖНО: если на слайде слова/фразы расположены в РАЗНЫХ местах или под РАЗНЫМИ углами — каждое слово/фраза = ОТДЕЛЬНЫЙ элемент. Например "How to use" и "Claude" — два разных элемента если они разного размера. "for *Brands*" — отдельный элемент если курсивный.
- x, y — координаты верхнего левого угла в % от ширины/высоты слайда. x=0 — левый край, x=50 — центр, x=100 — правый край. y=0 — верх, y=100 — низ. Будь точен — смотри где именно расположен текст на слайде.
...
- rotation: угол наклона текстового блока в градусах (-45 до 45). 0 если текст прямой горизонтальный. Если текст стоит под углом — укажи реальный угол.
...
- Максимум 10 текстовых элементов.
...
- Для овала, пилюли (pill), кнопки с закруглёнными краями (как "OUR WORKFLOWS →"): type="shape", shapeType="rect", borderRadius=999. Отдельно добавь text-элемент с текстом кнопки поверх.
- Для кружков: type="shape", shapeType="circle".
- fill — цвет заливки (hex или "transparent"), stroke — цвет обводки, strokeWidth — толщина (1-8).
- ВАЖНО: кнопки-пилюли, овалы, рамки — всегда делай как shape, не игнорируй их!
